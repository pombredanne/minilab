...
from ia.ocr.licenseplates.src.data import IMAGES_FOLDER
from ia.ocr.licenseplates.src.create_classifier import load_classifier
from ia.ocr.licenseplates.src import GrayscaleImage, NormalizedCharacterImage, Character

...
from ia.ocr.licenseplates.src.data import DATA_FOLDER, RESULTS_FOLDER
from ia.ocr.licenseplates.src.create_characters import load_learning_set, load_test_set

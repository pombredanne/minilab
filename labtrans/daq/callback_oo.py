# -*- coding: utf-8 -*-
"""
Created on Tue Oct  8 17:02:07 2013
...
def EveryNCallback_py(taskHandle, everyNsamplesEventType, nSamples, callbackData_ptr):
    ...
    read = int32()
    data = zeros(1000)
    DAQmxReadAnalogF64(taskHandle,500,10.0,DAQmx_Val_GroupByScanNumber,data,1000,byref(read),None)
...
task=Task()
task.CreateAIVoltageChan("Dev1/ai0, Dev1/ai1","",DAQmx_Val_RSE,-10.0,10.0,DAQmx_Val_Volts,None)
task.CfgSampClkTiming("",10000.0,DAQmx_Val_Rising,DAQmx_Val_ContSamps,500)

task.RegisterEveryNSamplesEvent(DAQmx_Val_Acquired_Into_Buffer,500,0,EveryNCallback,id_a)

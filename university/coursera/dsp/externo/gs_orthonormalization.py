...
def example2():
    # A set of orthonormal vectors.
    v0 = numpy.matrix([1/2, 1/2, 1/2, 1/2]).T
    v1 = numpy.matrix([1/2, 1/2, -1/2, -1/2]).T
    v2 = numpy.matrix([1/2, -1/2, 1/2, -1/2]).T
    v3 = numpy.matrix([1, 1, 1, 1]).T

    V = numpy.matrix([numpy.squeeze(numpy.asarray(v0)),
                      numpy.squeeze(numpy.asarray(v1)),
                      numpy.squeeze(numpy.asarray(v2)),
                      numpy.squeeze(numpy.asarray(v3))]).T
